...
<div class="container">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" value="<?php echo $username; ?>" name="title" id="Title" placeholder="Enter Title">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="Title">body:</label>
    <div class="col-sm-10">
      <textarea class="form-control" name="body" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Message"><?php echo $email; ?></textarea>
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-2" for="Slug">Slug:</label>
    <div class="col-sm-10">
      <input type="text" value="<?php echo $pass; ?>" name="slug" class="form-control" id="Slug" placeholder="Enter Slug">
...
$sql="UPDATE users SET username = '$post_titlee', password = '$slugg', email = '$bodyy', updated_at = current_timestamp() WHERE id = $userid;";//queryto
